...
best_accuracy = 0
r_factors = [4, 16, 32]  # different r factors to try

for r in r_factors:
    lora_model = apply_lora(model, r)
    ...
    for epoch in range(epochs):
        ...
        print(f"Epoch {epoch + 1}/{epochs} | r: {r} | Batch Size: {batch_size} | Learning Rate: {learning_rate}")
